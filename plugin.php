<?php
namespace OpenSeminar\MyPluginFtp;
        ...
        Route::fixed(
            ...
            function () {
                Route::get(
                    '/',
                    [
                        'as' => 'openseminar_myplugin_ftp::index',
                        'uses' => function (Request $request) {

                            $title = '오픈 세미나 플러그인 FTP';
                            ...
                            // output
                            return XePresenter::make('openseminar_myplugin_ftp::views.index', ['title' => $title]);
